define(function(){
    ...
    return {
        ...
        createCardDisplay: function(numtext, suit){
            ...
            // Cartes complètes façon Windows : on charge l'image SVG de la carte
            // (jeu domaine public). Nom de fichier = couleur + rang, ex. clubAce.svg.
            var rankWords = { J: 'Jack', Q: 'Queen', K: 'King', A: 'Ace' };
            var rankWord = rankWords[numtext] || numtext;
            display.classList.add('full');
            front.style.backgroundImage = "url('cards/" + suits[suit] + rankWord + ".svg')";
